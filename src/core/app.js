        ...
        <div class="flex-1 flex overflow-hidden">
          <div class="flex-[7] flex flex-col p-4 gap-4 overflow-hidden">
            <div class="relative flex-1 rounded-xl overflow-hidden" style="background:rgba(16,24,39,.8);border:1px solid #263148">
              ...
              <div class="absolute top-2 right-2 z-20 flex gap-2 items-center">
                <button id="field-toggle" class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors" style="background:rgba(40,53,73,.9);color:#d5e3fd;backdrop-filter:blur(4px)"><span class="material-symbols-outlined" style="font-size:16px">straighten</span> Calibrar</button>
                <button id="draw-toggle" class="px-2 py-1.5 rounded-lg text-xs transition-colors" style="background:rgba(40,53,73,.9);color:#d5e3fd;backdrop-filter:blur(4px)"><span class="material-symbols-outlined" style="font-size:16px">gesture</span></button>
              </div>
            </div>
            <div class="flex items-center gap-4 py-2">
              ...
              <div class="flex items-center gap-2 text-xs ml-auto" style="color:#c2cab0">
                <span>Ancho</span><input id="field-width" style="width:44px;background:#051426;border:1px solid #424935;border-radius:4px;padding:2px 4px;color:#aff73f;font-family:monospace;text-align:center" value="68" />
                <span>Largo</span><input id="field-length" style="width:44px;background:#051426;border:1px solid #424935;border-radius:4px;padding:2px 4px;color:#aff73f;font-family:monospace;text-align:center" value="105" />
              </div>
            </div>
            <div class="flex gap-3" style="min-height:140px">
              <div class="flex-1 rounded-xl overflow-hidden flex flex-col" style="background:rgba(16,24,39,.8);border:1px solid #263148">
                ...
                <div class="flex-1 relative" style="min-height:140px;background:radial-gradient(circle at center,#162235 0%,#101827 100%)">
